...
echo '<div class="no-job-listing"><p>' . esc_html__('There are currently no positions we are recruiting for at Lifeline, please check back again soon.', 'simple-job-board') . '</p>';
